        ...
        <div className="flex items-center justify-between space-x-4">
          ...
          <div className="relative z-50">
            <Select 
              ...
              onValueChange={(value) => {
                onUpdateActiveMediaTab(value)
              }}
            >
              <SelectTrigger className="w-40 bg-muted border border-border rounded-xl px-4 py-2 focus:ring-1 focus:ring-primary-500 cursor-pointer">
                <SelectValue />
              </SelectTrigger>
              <SelectContent 
